...
function main()
{
    ...
    CONTRACT_OWNER_ACCOUNT_BALANCE=$(_get_contract_key_value "$CONTRACT_HASH" "balances_$CONTRACT_OWNER_ACCOUNT_HASH")
    ...
    do
        ...
        USER_ACCOUNT_BALANCE=$(_get_contract_key_value "$CONTRACT_HASH" "balances_$USER_ACCOUNT_HASH")
